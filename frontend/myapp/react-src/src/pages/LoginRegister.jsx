  ...
  return (
    <div className="w-full h-full relative bg-slate-200 overflow-hidden" >
      ...
      <div className="w-146 h-44 left-1/2 transform -translate-x-1/2 top-[28%] absolute">
        <div className="left-0 top-0 absolute justify-start text-8xl font-bold select-none font-primary text-azul-2">CTRL+HOME</div>
        <div className="left-0 top-20 absolute w-full text-center text-3xl font-normal select-none font-secondary text-azul-2">Tu casa, a un comando de distancia</div>
      </div>
